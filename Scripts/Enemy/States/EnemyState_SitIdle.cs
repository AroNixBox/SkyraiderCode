...
{
    public class EnemyState_SitIdle : IState
    {
        private EnemyReferences _enemyReferences;
        public EnemyState_SitIdle(EnemyReferences enemyReferences)
        {
            _enemyReferences = enemyReferences;
        }
        public void OnEnter()
        {
            _enemyReferences.Animator.SetFloat(GlobalAnimationHashes.EnemyAnim_Speed, -1f);
