...
public class TutorialState_Objective : IState
{
    ...
    public TutorialState_Objective(TutorialReferences references, string objectiveGoal, string animationName, Color gizmoColor)
    {
    ...
    public void OnEnter()
    {
        _tutorialReferences.PlayerMeeleController.isInTutorial = true;
