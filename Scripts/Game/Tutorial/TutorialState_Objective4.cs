...
public class TutorialState_Objective4 : IState
{
    ...
    public TutorialState_Objective4(TutorialReferences references, string objectiveGoal, string animationName, Color gizmoColor)
    {
