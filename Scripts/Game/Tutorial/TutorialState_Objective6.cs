...
public class TutorialState_Objective6 : IState
{
    ...
    public TutorialState_Objective6(TutorialReferences references, string objectiveGoal, string animationName, Color gizmoColor)
    {
