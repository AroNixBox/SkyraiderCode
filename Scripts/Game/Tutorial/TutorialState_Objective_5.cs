...
public class TutorialState_Objective5 : IState
{
    ...
    public TutorialState_Objective5(TutorialReferences references, string objectiveGoal, string animationName, Color gizmoColor)
    {
