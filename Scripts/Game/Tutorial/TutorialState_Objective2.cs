...
public class TutorialState_Objective2 : IState
{
    ...
    public TutorialState_Objective2(TutorialReferences references, string objectiveGoal, string animationName, Color gizmoColor)
    {
